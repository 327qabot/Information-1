...
:ship: Course Project Assignment #3 - Testing  :ship: 
...
1. Now divide the front-end test cases (with features R1, R2, R3, R7, R8) you created at A1, and assign each team member the test cases to be created and ran locally. 
